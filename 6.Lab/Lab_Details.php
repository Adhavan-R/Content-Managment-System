...
<body>
  ...
  <div class="container" style="height: 402px;">
    <img class="thumbnail" src="/Project/Images/Lab.jpg" alt="hlo"><div class="heading">Laboratory Details</div>
  </div>
  <section>
    <div class="flx">
    ...
    if ($_SESSION['user'] == 'teacher') {
      $form = <<<ANYTHING
    <form action="lab_add_form.php">
        <button type="submit">Add</button>
    </form>
    <form action="lab_edit_form.php">
        <button type="submit">Edit</button>
    </form>
    <form action="lab_delete_form.php">
