...
<body>
  ...
  <div class="container" style="height: 402px;">
    <img class="thumbnail" src="/Project/Images/Publication.jpg" alt="hlo" style="object-position: top;" />
  ...
  <section>
    ...
    if ($_SESSION['user'] == 'teacher') {
      $form = <<<ANYTHING
      <form action="publication_add_form.php">
          <button type="submit">Add</button>
      </form>
      <form action="publication_edit_form.php">
          <button type="submit">Edit</button>
      </form>
      <form action="publication_delete_form.php">
