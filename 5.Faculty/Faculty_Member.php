...
<body>
  ...
  <div class="container" style="height: 402px;">
    <img class="thumbnail" src="/Project/Images/Faculty.jpg" alt="hlo" style="object-position:top;" />
    <div class="heading">Faculty Members</div>
  </div>
  <section>
    <div class="flx">
    ...
    if ($_SESSION['user'] == 'teacher') {
      $form = <<<ANYTHING
      <form action="Faculty_add_form.php">
          <button type="submit">Add</button>
      </form>
      <form action="Faculty_edit_form.php">
          <button type="submit">Edit</button>
      </form>
      <form action="faculty_delete_form.php">
