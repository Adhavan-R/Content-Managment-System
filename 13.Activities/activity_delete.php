...
<body>
            ...
            <?php
                ...
                if ($check == null) {
                  $create_query = mysqli_query($connect, " CREATE TABLE activities( 
                ...
                for ($i = 0; $i < $num_rows; $i++) {
                  ...
                  if ((int)$_POST['s_no'] == (int)$row['s_no']) {
                    ...
                    $myarray[] = array("title" => $row['title'],"date" => $row['date'],"year" => $row['year'],"file" => $row['file']);
                  }
                }
                ...
                if ($flag == 1) {
                    ...
                    for($i = 0; $i < $num_rows-1; $i++){
                        $insert_query = mysqli_query(
                          $connect,
                          "INSERT INTO activities( title,date,year,file) VALUES ('".$myarray[$i]['title']."' ,'".$myarray[$i]['date']."','".$myarray[$i]['year']."','".$myarray[$i]['file']."');"
                        );
                    }
                    ...
                    if ($truncate_query == true) {
                        ...
                        echo '<a href="/Project/13.Activities/Activities.php"> Ok </a>';
                    } else {
