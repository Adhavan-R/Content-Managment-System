...
<body>
  ...
  <div class="container" style="height: 402px;">
    <img class="thumbnail" src="/Project/Images/MOU.jpg" alt="hlo" />
    <div class="heading">MOU</div>
  </div>
  <section>
    <div class="flx">
    ...
    if ($_SESSION['user'] == 'teacher') {
      $form = <<<ANYTHING
      <form action="mou_add_form.php">
          <button type="submit">Add</button>
      </form>
      <form action="mou_edit_form.php">
          <button type="submit">Edit</button>
      </form>
      <form action="mou_delete_form.php">
