...
<body>
	...
	<div class="container" style="height: 402px;">
		<img class="thumbnail" src="/Project/Images/BOS.jpg" alt="hlo" />
		<div class="heading">Board of Studies</div>
	</div>
	<section>
		<div class="flx">
		...
		<div class="flx">
			...
			if ($_SESSION['user'] == 'teacher') {
				$form = <<<ANYTHING
		<form action="board_add_form.php">
			<button type="submit">Add</button>
		</form>
		<form action="board_edit_form.php">
			<button type="submit">Edit</button>
		</form>
		<form action="board_delete_form.php">
