...
<body>
  ...
  <div class="container" style="height: 402px;">
    <img class="thumbnail" src="/Project/Images/Consultancy.jpg" alt="hlo" />
    <div class="heading">Consultancy</div>
  </div>
  <section>
    <div class="flx">
    ...
    if ($_SESSION['user'] == 'teacher') {
      $form = <<<ANYTHING
      <form action="consultancy_add_form.php">
          <button type="submit">Add</button>
      </form>
      <form action="consultancy_edit_form.php">
          <button type="submit">Edit</button>
      </form>
      <form action="consultancy_delete_form.php">
