    ...
    if ($_FILES['file']['name'] != "") {
        ...
        if (!move_uploaded_file($_FILES['file']['tmp_name'], $file_name)) {
            ...
            $insert_query = mysqli_query(
                $connect,
                "UPDATE research SET name = '$name' ,  title = '$title' ,journal_name = '$journal_name' ,volume = '$volume',file = '$file' WHERE s_no = $s_no;"
            );
        }
    } else {
        $insert_query = mysqli_query(  
            $connect,
            "UPDATE research SET name = '$name' , title = '$title' ,journal_name = '$journal_name' ,volume = '$volume'  WHERE s_no = $s_no;"
        );
    }
