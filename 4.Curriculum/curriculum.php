...
<body>
  ...
  <div class="container" style="height: 402px;">
    <img class="thumbnail" src="/Project/Images/Curriculum.jpg" alt="hlo" />
    <div class="heading">Curriculum</div>
  </div>
  <section>
    <div class="flx">
    ...
    if ($_SESSION['user'] == 'teacher') {
      $form =<<<ANYTHING
        ...
        <form action="curriculum_edit_form.php">
          <button type="submit">Edit</button>
        </form>
        <form action="curriculum_delete_form.php">
